...
from basic.models import FCN_Encoder,FCN_UNet
    ...
    params = {
        "dataset_params": {
            ...
            "config": {
                ...
                "width_divisor": 8,  ##8  # Image width will be divided by 8
                "height_divisor": 32, ##32 # Image height will be divided by 32
        ...
        "model_params": {
            ...
            "transfer_learning": {
                "encoder": ["encoder", "outputs/RIMES_line_syn.pt", True, True],
                "decoder": ["decoder", "outputs/RIMES_line_syn.pt", True, False],
            },
            ...
            "input_UNet_channels": 256,  # number of channels of input image
        ...
        "training_params": {
            "output_folder": "Rimes_2011_line",  # Rimes_2011_line  IAM_2011_new folder name for checkpoint and results
            "max_nb_epochs": 5000, # maximum number of epochs before to stop
            "max_training_time": 3600 * 24 * 2.9,  # maximum time before to stop (in seconds)
            ...
            "focus_metric": "cer",  ###"cer"  # Metrics to focus on to determine best epoch
            "expected_metric_value": "low",  # ["high", "low"] What is best for the focus metric value
            "set_name_focus_metric": "{}-valid".format(dataset_name),  # Which dataset to focus on to select best weights
            "train_metrics": ["loss_ce", "cer", "wer"],  # Metrics name for training
            "eval_metrics": ["cer", "wer"],#"eval_metrics": ["cer", "wer"], #, "map_cer" # Metrics name for evaluation on validation set during training
