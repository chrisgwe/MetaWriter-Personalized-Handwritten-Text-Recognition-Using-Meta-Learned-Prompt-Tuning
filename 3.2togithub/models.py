    ...
    def forward(self, query, key, value, key_padding_mask=None, attn_mask=None, output_weights=True):
        ...
        if attn_mask is not None:
            ...
            if attn_mask.dtype == torch.bool:
                #attn_mask = attn_mask.repeat(1, 1, 2)# after auxiliary tesk need to expand
                #print("attn_maskdan",attn_mask.shape)
                #print("attn_output_weightsdan",attn_output_weights.shape)
